        ...
        <div className="p-4 space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              className="w-full px-3 py-3 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-800 rounded-lg text-gray-800 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:ring-2 focus:ring-yellow-500 outline-none resize-none"
            />
          </div>
