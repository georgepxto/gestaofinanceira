      ...
      >
        ...
        <div className="p-4 space-y-4">
          ...
          <div className="flex gap-3">
            <button
              onClick={onClose}
              className="flex-1 py-3 bg-zinc-100 dark:bg-white/[0.04] text-zinc-700 dark:text-zinc-300 font-medium rounded-xl hover:bg-zinc-200 dark:hover:bg-white/[0.08] transition-colors"
            >
              Cancelar
            </button>
            <button
