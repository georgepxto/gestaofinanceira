        ...
        <div className="p-4 space-y-4">
          ...
          <div className="flex gap-3 pt-2">
            <button
              ...
              onClick={onClose}
              disabled={saving}
              className={`flex-1 px-4 py-3 border text-gray-600 dark:text-gray-400 rounded-lg transition-colors ${
                saving
                  ? "border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 cursor-not-allowed"
