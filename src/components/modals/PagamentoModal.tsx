        ...
        <div className="p-4 space-y-3">
          ...
          <div className="flex gap-2">
            <button
              onClick={onClose}
              disabled={saving}
              className={`flex-1 px-4 py-2.5 text-zinc-800 dark:text-zinc-100 rounded-lg font-medium transition-colors text-sm ${
                saving
            ...
            <button
              ...
              disabled={saving}
              className={`flex-1 px-4 py-2.5 rounded-lg font-semibold transition-colors flex items-center justify-center gap-2 text-sm ${
                saving
