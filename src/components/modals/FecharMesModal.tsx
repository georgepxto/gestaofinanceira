    ...
    <div className="fixed inset-0 bg-black/40 z-modal flex items-end sm:items-center justify-center p-4">
      ...
      >
        <div className="p-4 border-b border-gray-200 dark:border-gray-800 flex items-center justify-between">
          <h2 id="fechar-mes-modal-title" className="text-lg font-semibold text-gray-800 dark:text-gray-100 flex items-center gap-2">
          ...
          {valorPago > 0 && (
            <div
              className={`rounded-lg p-4 ${
                valorParaDebito > 0
                  ? "bg-orange-900/30 border border-orange-200"
                  : "bg-green-900/30 border border-emerald-200"
              }`}
            >
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">Resumo:</p>
              <div className="space-y-1 text-sm">
                <div className="flex justify-between">
                  <span className="text-gray-500 dark:text-gray-400">Pagando agora:</span>
