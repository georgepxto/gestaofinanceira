    ...
    return (
      <NavLink
        ...
        className={`flex items-center gap-3 px-4 py-3 rounded-lg transition-all duration-200 ${
          isActive
            ? "bg-emerald-50 dark:bg-emerald-950/30 text-emerald-700 dark:text-emerald-400 font-semibold shadow-[inset_2px_0_0_#059669]"
    ...
    <>
      ...
      <header className="md:hidden fixed top-0 left-0 right-0 h-16 bg-white dark:bg-zinc-900 border-b border-zinc-200 dark:border-zinc-800 z-40 flex items-center justify-between px-4 shadow-sm">
        <div className="flex items-center">
          ...
          <h1 className="ml-2 text-lg font-display font-bold tracking-tight text-zinc-800 dark:text-zinc-100">
            Hedge
          </h1>
        </div>
      ...
      >
        ...
        <div className="h-16 flex items-center justify-between px-4 border-b border-zinc-200 dark:border-zinc-800">
          <div className="flex items-center gap-2">
            ...
            {!isCollapsed && (
              <h2 className="text-xl font-display font-bold tracking-tight text-zinc-800 dark:text-zinc-100">
                Hedge
              </h2>
            )}
          </div>
            ...
            {!isCollapsed && (
              <div className="flex items-center gap-3 px-2 py-2">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-zinc-800 dark:text-zinc-100 font-medium truncate">{userName || "Usuário"}</p>
